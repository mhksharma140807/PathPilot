              ...
              <section className={`rounded-3xl border p-6 shadow-sm transition md:p-8 ${progress >= 100 ? 'border-[#10B981]/40 bg-emerald-50/60' : 'border-slate-200/80 bg-white'}`}>
                ...
                <div className="mt-6 flex flex-wrap items-center gap-3 pt-4 border-t border-slate-100">
                  <button
                    ...
                    className="inline-flex items-center gap-2 rounded-xl bg-[#4F46E5] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#3730A3] shadow-md disabled:opacity-60 disabled:cursor-not-allowed"
                  >
                    {updating
                      ? "Updating..."
                      : progress >= 100
                  ...
                  {progress > 0 && progress < 100 && (
                    <button
                      ...
                      className="rounded-xl border border-slate-300 bg-white px-5 py-3 text-sm font-semibold text-[#0F172A] transition hover:bg-slate-50 disabled:opacity-60"
                    >
                      Complete Module (100%)
                    </button>
                  )}
                  ...
                  {progress > 0 && (
                    <button
                      ...
                      className="ml-auto text-xs font-semibold text-[#64748B] hover:text-red-600 transition"
                    >
                      Reset Progress
                    </button>
                  )}
              ...
              <section className="rounded-3xl border border-slate-200/80 bg-white p-6 shadow-sm md:p-8">
                ...
                <div className="mt-5 space-y-4 text-sm text-[#64748B]">
                  <div className="flex items-start gap-3">
                    <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-indigo-50 text-[#4F46E5] text-xs font-bold mt-0.5">
                      ✓
                    </div>
                    <div>
                      <p className="font-semibold text-[#0F172A]">Core Domain Foundations</p>
                      <p className="mt-0.5 text-xs text-[#64748B]">Master fundamental principles and real-world execution standards.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-[#0F172A]">Practical Implementation</p>
                      <p className="mt-0.5 text-xs text-[#64748B]">Apply industry techniques to produce showcase-ready outputs.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-[#0F172A]">Career-Ready Artifacts</p>
                      <p className="mt-0.5 text-xs text-[#64748B]">Demonstrate capability suitable for college or internship portfolios.</p>
                    </div>
                  </div>
                </div>
              </section>
