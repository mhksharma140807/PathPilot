...
function ResetPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const msg = err.message || "Failed to reset password. Please verify your OTP code.";
      setError(msg);
      toast.error(msg);
    } finally {
      setLoading(false);
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-slate-300 leading-relaxed">
                Enter the 6-digit verification code sent to your email along with your new password to restore access to your account.
              </p>
            </div>
          </div>
        ...
        <div className="lg:col-span-7 p-6 sm:p-10 lg:p-14 flex flex-col justify-between bg-white">
          <div className="w-full max-w-md mx-auto space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="reset-email-input" className="mb-1.5 block text-xs font-bold uppercase tracking-wider text-[#0F172A]">
                  Email Address
                </label>
                <input
              ...
              <div>
                <label htmlFor="reset-otp-input" className="mb-1.5 block text-xs font-bold uppercase tracking-wider text-[#0F172A]">
                ...
                <input
                  ...
                  maxLength={6}
                  required
                  className="w-full rounded-xl border border-slate-300 px-4 py-3 text-sm text-[#0F172A] tracking-widest font-mono text-center font-extrabold outline-none transition focus:border-[#2563EB] focus:ring-2 focus:ring-[#2563EB]/20"
                />
              </div>

              <div>
                <label htmlFor="reset-new-password" className="mb-1.5 block text-xs font-bold uppercase tracking-wider text-[#0F172A]">
                  New Password
                </label>
              ...
              <div>
                <label htmlFor="reset-confirm-password" className="mb-1.5 block text-xs font-bold uppercase tracking-wider text-[#0F172A]">
            ...
            <div className="border-t border-slate-100 pt-4 text-center">
              <p className="text-xs text-slate-600">
                Need a new code?{" "}
                <Link to="/forgot-password" className="font-bold text-[#2563EB] hover:underline focus:outline-none">
                  Request New OTP
                </Link>
              </p>
            </div>
